...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> <%@ taglib prefix="form"
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <c:if test="${empty orders}">
                    <div class="alert alert-warning text-center">lịch sử mua hàng của bạn đang trống.</div>
                </c:if>
